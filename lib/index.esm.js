...
/*#__PURE__*/
function () {
  function ActiveQuery(adapter, showQuery, listQuery) {
    _classCallCheck(this, ActiveQuery);
...
function (_BaseSource) {
  ...
  _createClass(CollectionSource, [{
    ...
    value: function handleResponse(response) {
      ...
      this._loading = false;
      this._records = this.recordData(response) && this.recordData(response).map(function (datum) {
    ...
    key: "recordData",
    value: function recordData(response) {
      var results = get(response, ['data', 'data', this.objectPath], null);
...
function connectSource (Component, sources) {
  return createReactClass({
    ...
    render: function render() {
      return React.createElement(Component, _extends({}, this.props, sources));
    }
  });
}
...
export { ActiveQuery, Adapter, BelongsTo, CollectionSource, HasMany, RecordSource, connectSource };
