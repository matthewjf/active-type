...
function (_EventTarget) {
  _inherits(RecordSource, _EventTarget);

  function RecordSource(type, query) {
    var _this;

    _classCallCheck(this, RecordSource);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(RecordSource).call(this));
    _this.type = type;
    _this.query = query;
...
var CollectionSource = function CollectionSource() {
...
export { Adapter, BelongsTo, CollectionSource, HasMany, Query, RecordSource, connectSource };
